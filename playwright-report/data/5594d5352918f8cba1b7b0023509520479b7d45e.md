...
```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:4173/admin
Call log:
  - navigating to "http://localhost:4173/admin", waiting until "load"
...
```ts
  ...
  5   |     await page.goto('http://localhost:4173/shop');
  6   |
  ...
  15  |     await page.goto('http://localhost:4173/shop');
  ...
  39  |     await page.goto('http://localhost:4173/shop');
  ...
  66  |     await page.goto('http://localhost:4173/shop');
  ...
  85  |     await page.goto('http://localhost:4173/shop');
...
> 102 |     await page.goto('http://localhost:4173/admin');
      |                ^ Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:4173/admin
  103 |
